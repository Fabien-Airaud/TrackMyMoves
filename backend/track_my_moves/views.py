...
@swagger_auto_schema(method="POST", request_body=UserSerializer(), responses={200: '{"token": apiToken, "account": AccountObject}', 400: [{"message": "enter a valid e-mail address."}, {"message": "enter a valid password."}]})
@api_view(['POST'])

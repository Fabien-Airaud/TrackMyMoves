...
@swagger_auto_schema(method="GET", manual_parameters=[{"name": "Authorization", "in": "header", "description": "API REST Token", "required": True}] ,responses={200: "log out successed"})
@api_view()
